    ...
    */
    ...
    fn: {
      ...
      */
      ...
      DOMprototype: {
        createPrototype: function( elements ){
          var prot = jUri.fn.DOMprototype;

          elements.addClass = prot.addClass;
          elements.removeClass = prot.removeClass;
          elements.hasClass = prot.hasClass;
          elements.toggleClass = prot.toggleClass;
